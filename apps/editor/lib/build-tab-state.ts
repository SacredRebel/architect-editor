...
export function getRoofFootprintSources(roofType: import('@pascal-app/core').RoofType) {
  return roofType === 'conical' ? CONICAL_ROOF_FOOTPRINT_SOURCES : STANDARD_ROOF_FOOTPRINT_SOURCES
}

export function getRoofFootprintSource(
  roofType: import('@pascal-app/core').RoofType,
  value: unknown,
): RoofFootprintSource {
